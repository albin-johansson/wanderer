...
class map_object final :
 ...
 public:
  ...
  ~map_object() override;
  explicit constexpr map_object(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  map_object(const map_object& from);
  map_object(map_object&& from) noexcept
    : map_object() {
    *this = ::std::move(from);
  }

  inline map_object& operator=(const map_object& from) {
    CopyFrom(from);
    return *this;
  }
  inline map_object& operator=(map_object&& from) noexcept {
  ...
  static const map_object& default_instance() {
    return *internal_default_instance();
  }
  static inline const map_object* internal_default_instance() {
    return reinterpret_cast<const map_object*>(
               &_map_object_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    0;

  friend void swap(map_object& a, map_object& b) {
    a.Swap(&b);
  }
  inline void Swap(map_object* other) {
  ...
  void UnsafeArenaSwap(map_object* other) {
    if (other == this) return;
  ...
  inline map_object* New() const final {
    return new map_object();
  }

  map_object* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<map_object>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const map_object& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom(const map_object& from);
  private:
...
// optional int32 id = 1;
inline bool map_object::_internal_has_id() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool map_object::has_id() const {
  return _internal_has_id();
}
inline void map_object::clear_id() {
  id_ = 0;
  _has_bits_[0] &= ~0x00000001u;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 map_object::_internal_id() const {
  return id_;
}
